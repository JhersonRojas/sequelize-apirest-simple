...
export const crearMov = async (req, resp) => {
    try {
        let { ID_movimiento, Estado, Estdo_permiso, Validacion_permiso, 
            Jornada_Reserva, Fecha_Inicio, Fecha_Entrega, Observacion, 
            fk_Usuario, Fk_id_elemento } = req.body
...
export const actualizarMov = async (req, resp) => {
    try {
        ...
        let { Estado, Estdo_permiso, Validacion_permiso, 
            Jornada_Reserva, Fecha_Inicio, Fecha_Entrega,
            Observacion, fk_Usuario, Fk_id_elemento } = req.body
