...
export const crearEle = async (req, resp) => {
    try {
        let { ID_Elemento, Tipo_Elemento, Imagen, Nombre_Elemento, Autor, Descripcion, Archivo_Aporte  } = req.body
...
export const actualizarEle = async (req, resp) => {
    try {
        ...
        let {Tipo_Elemento, Imagen, Nombre_Elemento, Autor, Descripcion, Archivo_Aporte } = req.body
